...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ZAMIAST Center(...) -> SingleChildScrollView(...)
      body: SingleChildScrollView(
        padding: const EdgeInsets.symmetric(horizontal: 16.0),
        child: Column(
          // Zamiast mainAxisSize: MainAxisSize.min, używamy domyślnego rozciągnięcia
          children: [
            Form(
              key: _formKey,
              child: Column(
                ...
                children: [
                  ...
                  // Usunięto SizedBox(height: 2.0) tuż pod polem "Name"
                  ...
                  SizedBox(
                    ...
                    child: CustomButton(
                      ...
                      style: T.buttonStandard.copyWith(
                        backgroundColor: MaterialStateProperty.all(T.violet_0),
                      ),
                    ),
                  ),
                  const SizedBox(height: 24.0),
