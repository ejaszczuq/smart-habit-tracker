...
/// Allows editing an existing habit. Supports both Yes/No and Checklist.
...
class _EditHabitScreenState extends State<EditHabitScreen> {
  ...
  /// Builds a Card-like section with a title and child widget.
  ...
  /// Builds a widget for inline editing of single-line text fields.
  ...
  void _openIconPicker() {
    // same approach as in CreateHabitScreen
  ...
  void dispose() {
    ...
    _daysPerPeriodController.dispose();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Edit Habit', style: T.h2.copyWith(color: T.black_0)),
